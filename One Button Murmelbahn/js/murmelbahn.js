...
function drawscreen() {
	...
	sensorKeyboard = new Block(
		world,
		{
			...
			color: "green",
			trigger: (ball, block) => {
				(movetype = 2), (restitutionPLayer = 0);
			},
		},
	...
	//Begrenzungen
	begrenzungPiano1 = new Block(
		world,
		{ x: 1350 + pianoplacing, y: 600, w: 40, h: 180, color: "red" },
		{ isStatic: true, angle: PI / 5 }
	);
	blocks.push(begrenzungPiano1);
	begrenzungPiano2 = new Block(
		world,
		{ x: 70 + pianoplacing, y: 600, w: 40, h: 180, color: "red" },
		{ isStatic: true, angle: -PI / 5 }
	);
	...
	flöteBase = new Block(
		world,
		{ x: xFlöteBase, y: yFlöteBase, w: 470, h: 20, color: "red" },
	...
	flöteSensor4 = new Block(
		world,
		{
			x: xFlöteunterteilung + abstandFlöteunterteilung * 3,
			y: yFlöteunterteilung - 18,
			w: wFlöteSensor,
			h: hFlöteSensor,
			color: "green",
	...
	drumstick1 = new Block(
		...
		{ density: 0.0003, friction: 1.5, frictionAir: 0.001 }
	);
	...
	becken = new Block(
		world,
		{
			x: xSchlagzeugTrommel + 50,
			y: ySchlagzeugTrommel - 300,
			w: 200,
			h: 8,
			color: "white",
		},
	...
	beckenSpacer1 = new Block(
		world,
		{
			x: xSchlagzeugTrommel + 85,
			y: ySchlagzeugTrommel - 250,
			w: 35,
			h: 50,
			color: "white",
		},
